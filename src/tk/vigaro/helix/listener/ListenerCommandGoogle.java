...
public class ListenerCommandGoogle extends ListenerAdapter {
    ...
    public void onMessage(MessageEvent event) throws Exception {
        ...
        if (msg.startsWith(Helix.botPrefix + "g") && ((msg.length() > 3 && msg.charAt(2) == ' ') || (msg.length() > 4 && Arrays.asList(Helix.valid).contains(msg.charAt(2)) && msg.charAt(3) == ' '))) {
            String q = msg.split(" ", 2)[1];
            String max = msg.charAt(2) == ' ' ? "1" : String.valueOf(msg.charAt(2));
